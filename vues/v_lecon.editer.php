<h3>Modifier la leçon de conduite numéro <?php echo $_GET['id']; ?></h3>
...
<form name="creer_lecon" action="main.php?rubrique=lecon&action=editer&id=<?php echo $_GET['id']; ?>" method="post" accept-charset="utf-8">
